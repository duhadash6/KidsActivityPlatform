<template>    
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="flex justify-end p-2">
                <button onclick="closeModal('sure')" type="button"
            ...
            <div class="p-6 pt-0 text-center">
                <svg class="w-20 h-20 text-black mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                    </path>
                </svg>
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Êtes-vous sûr de vouloir supprimer cette atelier?</h3>
